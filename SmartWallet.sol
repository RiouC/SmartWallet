...
contract SmartWallet is Ownable {
    ...
    event Approval(address indexed owner, address indexed manager, uint256 amount);
    // Exercice 2
    ...
    function _setAllowance(address owner_, address spender, uint256 amount) private {
